...
var db_config = {
    host: 'localhost',
    user: 'epardesh',
    password: 'epardesh@123#4',
    database: 'staging_epardesh'
};
...
//url = 'http://54.172.109.78/epardesh/epardesh-75way/web/app/content/img/'
//classified_url = 'http://54.172.109.78/epardesh/epardesh-75way/web/#/'
//matrimony_url = 'http://54.172.109.78/epardesh/epardesh-75way/web/#/'

//Production server global variables
url = 'http://www.epardesh.com/app/content/img/';
classified_url = 'http://www.epardesh.com/';
matrimony_url = 'http://www.epardesh.com/';
classified_url_email = 'http://www.epardesh.com/classified';


//PLIVO
var plivo = require('plivo');
api = plivo.RestAPI({
  authId: 'MAM2Q4MJC2N2VLYZG1OD',
  authToken: 'ZjQ0ZmZjOWM3Mjc2MDliYWM2MWU1OTZiYTgzMmVh',
});
...
app.post('/find_india_cities',admin);
app.post('/find_usa_cities',admin);
app.post('/find_states',admin);
...
app.post('/view_stats',manage_ads);
...
app.post('/remove_favourite_ad',manage_ads);
...
app.post('/filter_ads',view_ads);
app.post('/apply_classified_promocode', users);
app.post('/check_applied_promocode', users);
app.post('/send_email_in_ad', users);
app.post('/training_count',it_training_admin);
...
app.post('/matrimony_edit_promocode',matrimony_plans);
app.post('/matrimony_delete_promocode',matrimony_plans);
app.post('/matrimony_report_spam',matrimony_users);
app.post('/update_matrimony_badwords',matrimony_manage_users);
app.post('/view_matrimony_badwords',matrimony_manage_users);
app.post('/filter_matrimony_user',matrimony_manage_users);
app.post('/delete_matrimony_user',matrimony_manage_users);
