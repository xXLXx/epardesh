(function() {
    ...
    TrainingCtrl.$inject = ['$rootScope', '$scope', '$auth', '$state', '$sessionStorage', '$timeout', 'TrainingServices', 'loginRegiServices', 'manageadServices'];
    function TrainingCtrl($rootScope, $scope, $auth, $state, $sessionStorage, $timeout, TrainingServices, loginRegiServices, manageadServices) {
