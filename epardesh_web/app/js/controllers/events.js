(function() {
    ...
    EventsCtrl.$inject = ['$rootScope', '$scope', '$auth', '$state', '$sessionStorage', '$timeout', 'EventServices', 'loginRegiServices', 'manageadServices'];
    function EventsCtrl($rootScope, $scope, $auth, $state, $sessionStorage, $timeout, EventServices, loginRegiServices, manageadServices) {
