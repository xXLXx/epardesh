    ...
    angular.module('satellizer', [])
        ...
        providers: {
            facebook: {
                name: 'facebook',
//                url: '/auth/facebook',
                 url: 'http://www.epardesh.com:4000/auth/facebook',
            ...
            facebook1: {
                name: 'facebook',
//                url: 'http://54.172.109.78:4000/matrimony/facebook',
                  url: 'http://www.epardesh.com:4000/matrimony/facebook',
                authorizationEndpoint: 'https://www.facebook.com/v2.5/dialog/oauth',
                redirectUri: window.location.origin + '/',
                requiredUrlParams: ['display', 'scope'],
                scope: ['email'],
            ...
            google: {
                name: 'google',
//                url: 'http://54.172.109.78:4000/auth/google',
                 url: 'http://www.epardesh.com:4000/auth/google',
                authorizationEndpoint: 'https://accounts.google.com/o/oauth2/auth',
                redirectUri: window.location.origin,
                requiredUrlParams: ['scope'],
                optionalUrlParams: ['display', 'state', 'user_type'],
                scope: ['profile', 'email'],
                scopePrefix: 'openid',
                scopeDelimiter: ' ',
                display: 'popup',
            ...
            google1: {
                name: 'google',
//                url: 'http://54.172.109.78:4000/matrimony/google',
                  url: 'http://www.epardesh.com:4000/matrimony/google',
                authorizationEndpoint: 'https://accounts.google.com/o/oauth2/auth',
                redirectUri: window.location.origin,
                requiredUrlParams: ['scope'],
                optionalUrlParams: ['display', 'state', 'user_type'],
            ...
            linkedin: {
                name: 'linkedin',
                url: 'http://54.172.109.78:3000/auth/linkedin',
//                 url: 'http://www.epardesh.com:3000/auth/linkedin',
            ...
            twitter: {
                name: 'twitter',
                url: 'http://54.172.109.78:3000/auth/twitter',
//                 url: 'http://www.epardesh.com:3000/auth/twitter',
        ...
        function($q, $http, $window, $timeout, popup, utils, config, storage) {
            return function() {
                ...
                var defaults = {
                    defaultUrlParams: ['response_type', 'client_id', 'redirect_uri', 'user_type'],
                    responseType: 'code',
                    responseParams: {
                        code: 'code',
                        clientId: 'clientId',
                        redirectUri: 'redirectUri',
                        user_type: localStorage.getItem('utype')
                    }
                };
