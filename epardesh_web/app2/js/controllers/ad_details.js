(function() {
    ...
    adDetailsCtrl.$inject = ['$rootScope', '$scope', '$state', '$timeout', 'adDataServices', '$stateParams', 'loginRegiServices'];
    function adDetailsCtrl($rootScope, $scope, $state, $timeout, adDataServices, $stateParams, loginRegiServices) {
        var vm = this;
