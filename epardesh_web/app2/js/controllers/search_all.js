(function() {
    ...
    SearchAllCtrl.$inject = ['$scope', '$auth', '$state', '$sessionStorage', '$timeout', 'EventServices','adDataServices','TrainingServices','loginRegiServices'];
    function SearchAllCtrl($scope, $auth, $state, $sessionStorage, $timeout, EventServices,adDataServices,TrainingServices,loginRegiServices) {
        var vm = this;
