(function() {
    ...
    SearchTrainingCtrl.$inject = ['$scope', '$auth', '$state', '$sessionStorage', '$timeout', 'TrainingServices', 'loginRegiServices'];
    function SearchTrainingCtrl($scope, $auth, $state, $sessionStorage, $timeout, TrainingServices, loginRegiServices) {
        var vm = this;
