...
//                    str += '</td>';
                        ...
                        str += ' <span><a href="javascript:;"><button type="button" id="' + id + '" class="btn delete-btn">Delete</button></a></span>';
                        if (block_status == '0') {
                            str += '<span> <a href="javascript:;"><button type="button" id="' + id + '" status="1" class="btn block-btn blck">Block</button></a></span>';
                        } else {
                            str += ' <span><a href="javascript:;"><button type="button" id="' + id + '" status="0" class="btn block-btn">Unblock</button></a></td>';
                        }
                        str += '</td>'
                        str += '</tr>';
                    }
