...
//                    str += '<td>' + viewname + '</td>';
                    str += '<td>' + viewprice + '</td>';
                    str += '<td>';
                    str += '<a  class="btn btn-primary btn-sm" id="edit-plansmodal" data-toggle="modal" value="' + view_id + '"p_type="' + viewtype + '" name="' + viewname + '" p_price="' + viewprice + '"  data-target="#modal-editplan" style="margin-right:15px;><i class="fa fa-pencil-square-o"></i>Edit</a>';
                    str += '</td>';
                    str += '</tr>';
                }
...
//               alert('Price can not be negative');
               showError("Price can not be negative");
//                $timeout(2000);
                return false;
            }
