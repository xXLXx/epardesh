...
//        }
        ...
        function onBtnClickofSendSMS(data) {
            ...
            if (localStorage.getItem('m_user_type') == 'platinum' || localStorage.getItem('m_user_type') == 'Platinum' || localStorage.getItem('m_user_type') == 'gold' || localStorage.getItem('m_user_type') == 'Gold') {
                $('#SMSModal').modal('show');
            } else {
...
//                receiver_profile_id: data.profile_id,
        ...
        function updatePartnerPreFun(status, act) {
            ...
            if (vm.updatePartnerObj.min_height != null) {
                ...
                vm.updatePartnerObj.min_height_in_cm = data.split('-')[1];
            }
            if (vm.updatePartnerObj.max_height != null) {
                var data = vm.updatePartnerObj.max_height;
                vm.updatePartnerObj.max_height_in_cm = data.split('-')[1];
            }
...
//            alert(vm.price);
            ...
            if (status != 0) {
                ...
                //editionPayment.payment.checkout('PayPal', vm.price, "http://192.168.1.101:8888/epardesh-web/web/#/matrimony_profile/1");
