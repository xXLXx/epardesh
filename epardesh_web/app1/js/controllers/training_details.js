(function() {
    ...
    TrainingDetailsCtrl.$inject = ['$rootScope', '$scope', '$state', '$timeout', 'TrainingServices', '$stateParams','adDataServices','loginRegiServices'];
    function TrainingDetailsCtrl($rootScope, $scope, $state, $timeout, TrainingServices, $stateParams,adDataServices,loginRegiServices) {
        var vm = this;
